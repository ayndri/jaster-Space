                    ...
                    <div class="item_order targetfields d-flex" id="item_order">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="paketTrx[]" id="selpost" required="">
                                    <option disabled>{{ $webs->paketTrx }}</option>
                        ...
                        <div class="form-group" style="width: 100px;">
                            ...
                            <input class="qty form-control" type="number" name="qtyTrx[]" value="{{ $webs->qtyTrx }}" required>
                        </div>
                        <div class="form-group">
                            <label class="col-form-label">Harga</label>
                            <input class="harga form-control" type="text" name="hargaTrx[]" value="{{ $webs->hargaTrx }}" required>
                        </div>
                    </div>    
                    </div>
